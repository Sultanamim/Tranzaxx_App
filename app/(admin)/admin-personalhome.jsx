  ...
  return (
    <ScrollView className=" bg-white ">
            ...
            <Image
              ...
              source={
                userInfo?.photo_url
                  ...
                  : require("../../assets/images/human2.png")
              }
              resizeMode="cover"
            />
          </View>
      ...
      <View className="  mx-4 mt-[6px]">
        <Text className=" font-poppins font-semibold text-[20px]  text-primaryBlk">
          Admin
        </Text>
      ...
      <View className=" bg-[#E6F7FE] py-5 px-6 mt-10 flex flex-row  justify-between border-b-[1px] border-b-[#BFBFBF]">
        <View className=" w-[42%] flex flex-col justify-center items-center">
          ...
          <MaterialCommunityIcons
            ...
            color="#00AEF0"
          />
          <Text className=" font-poppins font-medium text-[14px] text-[#8F8F8F] mt-2  mb-1">
            Joined
          </Text>
          <Text className=" font-poppins font-semibold text-[18px] text-[#010101]">
            May 17th, 2022
          </Text>
          {/* </View> */}
        </View>
      ...
      <View className="  mx-4 mt-10 rounded-xl px-6 py-6  border-[1px] border-[#BFBFBF] ">
        <View className="flex flex-row justify-center pb-4 border-b-[1px] border-b-[#BFBFBF] ">
          ...
          <Text
            className="  ml-2 font-poppins font-bold text-[20px] text-[#00AEF0]"
      ...
      <View className="  mx-4 mt-10 rounded-xl px-6 py-6  border-[1px] border-[#BFBFBF] ">
        <View className="flex flex-row justify-center pb-4 border-b-[1px] border-b-[#BFBFBF] ">
          ...
          <Text className="  ml-2 font-poppins font-bold text-[20px] text-[#00AEF0]">
            Settings
          </Text>
        </View>
        <View className=" mt-6">
          <DataForm fromDatas={settingsForm}>
            <Text className="  leading-5 font-poppins font-medium  text-[14px] text-[#8F8F8F]">
              {" "}
              NOTE: If no preferred time zone is selected, the Country's
              preferred time {"\n"}
              zone will be used for the front-office dates (e.g.{" "}
              <Text className=" text-[#010101]">
                "America/Toronto”
              </Text> for {"\n"}
              <Text className=" text-[#010101]"> Canada</Text>) and{" "}
              <Text className=" text-[#010101]">“utc”</Text> will be used for
              the admin panel dates.
            </Text>
          </DataForm>
        </View>
      </View>
