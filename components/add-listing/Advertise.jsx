...
function Advertise({ advertiseData, setAdvertiseData, negotiable, setNegotiable }) {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        setCanadaCities(data?.result.data?.map(({ name, id }) => ({ name, id })));
      } catch (error) {
  ...
  const handleCategorySelect = (category) => {
    ...
    const seletedcategoryId = selectingProduct.find(item => item.name === category)?.id;
    setAdvertiseData(prev => ({ ...prev, selected_Category_id: seletedcategoryId }))
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      ...
      setAdvertiseData(prev => ({ ...prev, thumbnail: result.assets[0].uri }))
    }
  };
    ...
    <>
      ...
      <View className=" mt-[25px] ">
        ...
        <TextInput
          ...
          onChangeText={(e) => setAdvertiseData(prev => ({ ...prev, title: e }))}
        />
        <Text
        ...
        <View className=" mt-[25px] ">
          ...
          <TextInput
            ...
            onChangeText={(e) => setAdvertiseData(prev => ({ ...prev, description: e }))}
          />
        </View>
        {/* Thumbnail */}
        <View className="mt-[25px]">
        ...
        >
          ...
          <TextInput className="" placeholder="ENTER PRICE"
            ...
            onChangeText={(e) => setAdvertiseData(prev => ({ ...prev, price: e }))}
        ...
        <TextInput
          ...
          onChangeText={(e) => setAdvertiseData(prev => ({ ...prev, tags: e }))}
        />
        <Text
